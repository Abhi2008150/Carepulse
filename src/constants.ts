import { Patient, Doctor, Appointment, Report, Medicine, HealthMetric, SOAPNote } from './types';
...
export const DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    avatar: 'https://picsum.photos/seed/doctor3/200',
  },
];
...
export const HEALTH_METRICS: HealthMetric[] = [
  { date: 'Mar 01', bp_systolic: 120, bp_diastolic: 80, heartRate: 72, sugar: 95 },
  { date: 'Mar 05', bp_systolic: 122, bp_diastolic: 82, heartRate: 75, sugar: 98 },
  { date: 'Mar 10', bp_systolic: 118, bp_diastolic: 78, heartRate: 70, sugar: 92 },
  { date: 'Mar 15', bp_systolic: 121, bp_diastolic: 81, heartRate: 73, sugar: 96 },
];
